...
# FIXME SyntaxError: duplicate argument 'destin_folder' in function definition
def cropping128(filename, ipname, destin_folder, output, destin_folder_2, size): #destin_folder in str  
    '''
    ...
    filename: is the path of the firescar raster, containing the geospatial information required for the cropping
